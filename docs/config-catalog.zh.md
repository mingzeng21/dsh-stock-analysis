...
来源：[`packages/api/stock-controller/src/index.ts:114`](../packages/api/stock-controller/src/index.ts)

<a id="deepseek-aidsh-api-watchlist-controller"></a>

## `@deepseek-ai/dsh-api-watchlist-controller`

需要：`storageDomain` · `stock`
...
来源：[`packages/api/watchlist-controller/src/index.ts:45`](../packages/api/watchlist-controller/src/index.ts)
...
来源：[`packages/stock/stock/src/index.ts:91`](../packages/stock/stock/src/index.ts)
...
来源：[`packages/stock/stock-hithink/src/index.ts:50`](../packages/stock/stock-hithink/src/index.ts)
...
来源：[`packages/stock/stock-iwencai/src/index.ts:59`](../packages/stock/stock-iwencai/src/index.ts)
...
来源：[`packages/stock/tool-stock/src/index.ts:32`](../packages/stock/tool-stock/src/index.ts)
