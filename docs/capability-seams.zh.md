...
flowchart LR
  ...
  pkg_stock["stock"]
  svc_stock["ctx.stock<br/>Stock market data provider registry"]
...
| `ctx.stock` | `seam` | [`stock`](../packages/stock/stock) | [`stock-hithink`](../packages/stock/stock-hithink) | [`tool-stock`](../packages/stock/tool-stock) | - | 一个 ctx.stock seam 服务厂商发布的全部资产类别；tool-stock 把每条注册表能力变成一个原生工具，且只由 stock-analysis preset 挂载。 |
