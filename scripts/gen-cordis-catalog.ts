...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  StockCatalogQuery: 'stock.md',
  StockEndpoint: 'stock.md',
  StockMeta: 'stock.md',
  StockParamValue: 'stock.md',
  StockProvider: 'stock.md',
  StockProviderRequest: 'stock.md',
  StockResult: 'stock.md',
  StockRow: 'stock.md',
  SymbolMatch: 'stock.md',
  SymbolQueryOptions: 'stock.md',
