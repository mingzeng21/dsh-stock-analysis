...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  {
    key: 'watchlist.analysis',
    kind: 'single',
    scope: 'session',
    summary: 'The analysis pane\'s transcript.',
    doc: 'The analysis pane\'s transcript. Declared by the Watchlist entry and\noccupied by this plugin\'s own body; `session`-scoped so the renderer\nbinds it to the current session and hands it `useChat`.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'main\' (client-ui-watchlist), so it exists while that entry is mounted',
    occupants: [
      'client-ui-watchlist AnalysisTranscript',
    ],
    replaceRisk: 'shadows-shipped-ui',
